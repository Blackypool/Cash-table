...
__________________________________________________________
# Исследование эффективности (своего)кеширования при повторном поиске слова

<img width="1280" height="992" alt="IMAGE 2026-05-02 17:06:11" src="https://github.com/user-attachments/assets/886785c4-d380-4d6d-944a-732d61167306" />

## Исходя из графиков видно, что при вероятности повтора, превышающей 78.6%, наиболее эффективной стратегией является сохранение последнего поиска в структуру самой таблицы.
